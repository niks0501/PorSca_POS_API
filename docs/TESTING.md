...
Success: Newman reports 16 requests and all assertions passing. The seeded database must be fresh before this run because the collection creates a managed product and buys one seeded product, reducing its stock.
